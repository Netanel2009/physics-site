    ...
    if(authForm) {
        ...
        authForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                errorEl.innerText = "שגיאה: אימייל או סיסמה שגויים";
...
// אלו הפונקציות שהיו חסרות בקוד שלך והוספתי אותן כדי שהאתר יעבוד
...
function renderAdminLogin() {
    ...
    app.innerHTML = `<section><div class="form-container"><h2>כניסת מנהל</h2><button class="btn-back" onclick="router('home')">חזור</button></div></section>`;

}



// --- 7. פונקציות לוגיקה כלליות (מוצמדות ל-window) ---
